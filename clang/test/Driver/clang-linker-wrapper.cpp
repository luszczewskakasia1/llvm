...
// CHK-CMDS-AOT-NV-NEXT: fatbinary{{.*}} --create [[FATBINOUT:.*]] --image3=kind=elf,sm={{(compute_)?50|pute_50}},file=[[CLANGOUT]] --image3=kind=elf,sm=50,file=[[PTXASOUT]]
...
// CHK-CMDS-AOT-NV-EMBED-IR-NEXT: fatbinary{{.*}} --create [[FATBINOUT:.*]] --image3=kind=elf,sm={{(compute_)?50|pute_50}},file=[[CLANGOUT]] --image3=kind=elf,sm=50,file=[[PTXASOUT]]
